...
![벡터 덧셈·뺄셈과 스칼라배](../../assets/study/linear-algebra-00-basics/vector-add-scalar.png)
...
![Ax=b의 구성 요소와 행·열 표기](../../assets/study/linear-algebra-00-basics/notation-ax-b.png)
...
![방향에 따른 내적 변화](../../assets/study/linear-algebra-00-basics/03-dot-direction.png)
...
![노름별 단위원(단위공)](../../assets/study/linear-algebra-00-basics/04-norm-unit-balls.png)
*정사각형(∞)이 원(2)을, 원이 마름모(1)를 감싼다.*

### 정사영(projection): 벡터를 다른 벡터 위로 내리기

![벡터 a를 b 위로 정사영](../../assets/study/linear-algebra-00-basics/05-projection.png)
...
![행렬 곱을 보는 4가지 관점](../../assets/study/linear-algebra-00-basics/06-matmul-4views.png)
...
![선형결합과 span](../../assets/study/linear-algebra-00-basics/07-span.png)
...
![정의역 → 치역, 네 부분공간의 흐름](../../assets/study/linear-algebra-00-basics/08-four-subspaces.png)
